{% macro orders_stg_suite(trg_table)%}
    ...
    {{date_format_YYYY_MM_DD(var("db_src"),var("src_schema"),var("dc_src_table_orders"),var("db_trg"),var("trg_schema"),trg_table,var("check_date_format_column"),results_suite_time[0],'orders_stg_suitetrg')}}

    --Test Case: Top 1 value check
    {{top1_value_check(var("db_src"),var("src_schema"),var("dc_src_table_orders"),var("db_trg"),var("trg_schema"),trg_table,var("check_column"),results_suite_time[0],'orders_stg_suite',var("list_check"))}}
